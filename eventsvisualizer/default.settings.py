# Django settings for eventsvisualizer project.
import os
...
STATIC_ROOT = APP_ROOT + "/static_dir"
...
SECRET_KEY = ')k9#9z(g#rs!yjzks-3cb(zjrnb*8)sr+7c6443sex8ur738%='
...
ROOT_URLCONF = 'eventsvisualizer.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'eventsvisualizer.wsgi.application'
